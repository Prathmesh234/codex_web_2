...
export function TaskCardDel({ message, repoName, branchName, browserCount }: TaskCardDelProps) {
  return (
    <Card className="flex items-center justify-between px-4 py-3 shadow-sm border rounded-lg">
      ...
      <span className="text-red-500 text-xs font-semibold ml-4">Deleted</span>
    </Card>
  )
} 